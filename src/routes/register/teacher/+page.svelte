...
<div class="min-h-screen bg-slate-50 text-slate-900">
	...
	<div class="mx-auto flex min-h-screen max-w-7xl items-center px-4 py-6 sm:px-6 lg:px-8">
		...
		>
			<section
				class="order-2 flex flex-col border-t border-slate-200 bg-linear-to-br from-sky-50 via-white to-emerald-50 p-6 text-slate-900 lg:order-1 lg:border-t-0 lg:border-r lg:border-r-slate-200 lg:p-10"
			>
				...
				<div class="mt-10 max-w-xl">
					...
					<p class="mt-5 text-base leading-8 text-slate-600">
						Acesse o núcleo operacional do Class Insights para gerenciar turmas, avaliações, notas,
						importações e acompanhamento pedagógico com mais confiança.
					</p>
				</div>
				...
				<div class="mt-8 grid gap-3">
					...
					>
						<div
							class="mt-1 flex h-10 w-10 items-center justify-center rounded-xl bg-sky-100 text-sky-700"
						>
							<svg
								class="h-5 w-5"
								fill="none"
						...
						<div>
							...
							<p class="mt-1 text-sm leading-6 text-slate-600">
								Crie turmas, organize avaliações e publique resultados sem depender de planilhas
								soltas.
							</p>
						</div>
					</div>
					...
					>
						<div
							class="mt-1 flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-100 text-emerald-700"
						>
							<svg
								class="h-5 w-5"
								fill="none"
					...
					>
						<div
							class="mt-1 flex h-10 w-10 items-center justify-center rounded-xl bg-amber-100 text-amber-700"
						>
							<svg
								class="h-5 w-5"
								fill="none"
						...
						<div>
							...
							<p class="mt-1 text-sm leading-6 text-slate-600">
								Importações, histórico longitudinal e experiência por perfil já entram no mesmo
								ecossistema.
							</p>
						</div>
					</div>
				...
				<div class="mt-8 rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
					...
					<div class="mt-5 grid gap-4 md:grid-cols-2">
						<div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
							<p class="text-xs font-black uppercase tracking-widest text-sky-700">Operação</p>
						...
						<div class="rounded-2xl border border-slate-200 bg-slate-50 p-4">
							<p class="text-xs font-black uppercase tracking-widest text-emerald-700">Leitura</p>
