<script lang="ts">
	import type { TeacherAssessmentsSummaryMetric } from '$lib/types/teacher';

	type Props = {
		metrics: TeacherAssessmentsSummaryMetric[];
	};

	let { metrics }: Props = $props();

	function panelClass(tone: TeacherAssessmentsSummaryMetric['tone']) {
	...
	function valueClass(tone: TeacherAssessmentsSummaryMetric['tone']) {
